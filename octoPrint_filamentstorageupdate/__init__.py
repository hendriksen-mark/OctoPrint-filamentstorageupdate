...
class FilamentstorageupdatePlugin(octoprint.plugin.StartupPlugin,
	...
	def get_assets(self):
		...
		# core UI here.
		return dict(
			js=["js/filamentstorageupdate.js"],
			css=["css/filamentstorageupdate.css"],
		)
	...
	def get_update_information(self):
		...
		# for details.
		return dict(
			filamentstorageupdate=dict(
				displayName="Filament Storage Update",
				displayVersion=self._plugin_version,

				# version check: github repository
				type="github_release",
				user="waltmoorhouse",
				repo="OctoPrint-filamentstorageupdate",
				current=self._plugin_version,

				# update method: pip
				pip="https://github.com/waltmoorhouse/OctoPrint-Filamentstorageupdate/archive/{target_version}.zip"
			)
		)
...
__plugin_name__ = "Filament Storage Update"
__plugin_pythoncompat__ = ">2.7,<4"


def __plugin_load__():
	global __plugin_implementation__
	__plugin_implementation__ = FilamentstorageupdatePlugin()
