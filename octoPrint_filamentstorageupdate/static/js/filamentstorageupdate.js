/*
 * View model for OctoPrint-Filamentstorageupdate
 *
 * Author: Walt Moorhouse
 * License: AGPLv3
 */
$(function() {
    function FilamentstorageupdateViewModel(parameters) {
        var self = this;
        ...
        self.onBeforeBinding = () => {
            ...
            self.boxExtrusion("0.00");
            self.gcodeExtrusion("0.00");
            self.newMaxH(self.settings.settings.plugins.filamentstorageupdate.maxH());
            self.newMaxT(self.settings.settings.plugins.filamentstorageupdate.maxT());
            self.warnTemp(self.settings.settings.plugins.filamentstorageupdate.humidityWarnPercentage());
        ...
        self.onDataUpdaterPluginMessage = (pluginIdent, message) => {
            if (pluginIdent === "filamentstorageupdate") {
        ...
        self.ajaxRequest = payload => {
            return $.ajax({
                url: API_BASEURL + "plugin/filamentstorageupdate",
                type: "POST",
                dataType: "json",
    ...
    OCTOPRINT_VIEWMODELS.push({
        construct: FilamentstorageupdateViewModel,
        // ViewModels your plugin depends on, e.g. loginStateViewModel, settingsViewModel, ...
        dependencies: [ "settingsViewModel" ],
        // Elements to bind to, e.g. #settings_plugin_Filamentstorageupdate, #tab_plugin_Filamentstorageupdate, ...
        elements: [ "#tab_plugin_filamentstorageupdate", "#navbar_plugin_filamentstorageupdate" ]
    });
});
